...
# Define the SQL query to insert the data into the table
    insert_query = ("INSERT INTO dbo.FB_Followers_By_Country_KS (PageID, MetricName, Country_Code, Value)"
                            "VALUES (?, ?, ?, ?)")
    # Execute the SQL query
    cursor.execute(insert_query, ("109818058023623", metric_name, country_code, value))
    conn.commit()
